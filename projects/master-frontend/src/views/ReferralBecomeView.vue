...
<template>
  <main>
    <ViewJumbotron
      :kicker="t('home.becomeReferral')"
      :title="t('referralBecome.title')"
      :subtitle="t('referralBecome.subtitle')"
      variant="referral"
    />
    <ViewSubnav :items="navItems" aria-label="Referral activation navigation" />

    <section class="become-shell grid min-h-dvh place-items-center px-4 py-4">
      <section
