export default {
  ...
  account: {
    ...
    discordTitle: 'Discord account',
    discordIntro:
      'Link your Discord account to verify through the Discord bot and claim the Discord bounty. Generate a code, then run the verify command in the Capitalism Discord.',
    discordGenerate: 'Generate verification code',
    discordGenerating: 'Generating…',
    discordLinkError: 'Failed to generate a Discord verification code.',
    discordCodeLabel: 'Your verification code:',
    discordCommandHint: 'Run this command in Discord:',
    discordExpiryHint: 'This code is single-use and expires soon. Generate a new one if it stops working.',
    discordJoin: 'Join the Capitalism Discord',
