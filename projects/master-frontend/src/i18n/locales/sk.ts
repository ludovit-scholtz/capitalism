export default {
  ...
  gameSettings: {
    ...
    subtitle: 'Spravujte meno osobného účtu, ktoré sa zobrazuje na všetkých herných serveroch Capitalism a v rebríčkoch.',
    cardTitle: 'Meno osobného účtu',
    cardBody: 'Tento alias naprieč servermi je uložený na master serveri a znovu použitý každým bežiacim herným shard-om.',
    warning: 'Nepoužívajte svoju skutočnú právnu identitu. Zvoľte si fiktívny alias pre verejné rebríčky a hráčske povrchy.',
    ...
    usageBodyShard: 'Aktualizovaný alias sa odošle na bežiace herné shard-y a zobrazí sa v shard rebríčkoch aj menovkách osobného účtu.',
    usageTitleMaster: 'Použitie na masteri',
    usageBodyMaster: 'Rovnaké meno sa používa v master rebríčku, vašom master profile a na zdieľaných povrchoch naprieč servermi.',
  },
  goldAdmin: {
