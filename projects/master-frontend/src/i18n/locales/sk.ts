export default {
  ...
  account: {
    ...
    discordTitle: 'Discord účet',
    discordIntro:
      'Prepojte svoj Discord účet, aby ste sa overili cez Discord bota a získali Discord odmenu. Vygenerujte kód a potom spustite príkaz na overenie v Capitalism Discorde.',
    discordGenerate: 'Vygenerovať overovací kód',
    discordGenerating: 'Generuje sa…',
    discordLinkError: 'Nepodarilo sa vygenerovať Discord overovací kód.',
    discordCodeLabel: 'Váš overovací kód:',
    discordCommandHint: 'Spustite tento príkaz v Discorde:',
    discordExpiryHint: 'Tento kód je jednorazový a čoskoro vyprší. Ak prestane fungovať, vygenerujte nový.',
    discordJoin: 'Pripojiť sa do Capitalism Discordu',
