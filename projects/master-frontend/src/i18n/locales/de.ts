export default {
  ...
  account: {
    ...
    discordTitle: 'Discord-Konto',
    discordIntro:
      'Verknüpfe dein Discord-Konto, um dich über den Discord-Bot zu verifizieren und die Discord-Belohnung zu erhalten. Erzeuge einen Code und führe dann den Verifizierungsbefehl im Capitalism-Discord aus.',
    discordGenerate: 'Verifizierungscode erzeugen',
    discordGenerating: 'Wird erzeugt…',
    discordLinkError: 'Discord-Verifizierungscode konnte nicht erzeugt werden.',
    discordCodeLabel: 'Dein Verifizierungscode:',
    discordCommandHint: 'Führe diesen Befehl in Discord aus:',
    discordExpiryHint: 'Dieser Code ist einmalig und läuft bald ab. Erzeuge einen neuen, falls er nicht mehr funktioniert.',
    discordJoin: 'Tritt dem Capitalism-Discord bei',
