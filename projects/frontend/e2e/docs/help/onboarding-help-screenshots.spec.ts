...
test.describe('Onboarding help FullHD screenshots', () => {
  test('capture six real 1920x1080 onboarding steps', async ({ page }) => {
    ...
    const step1Path = path.join(OUTPUT_DIR, 'step-1-industry.png')
    ...
    const step2Path = path.join(OUTPUT_DIR, 'step-2-product.png')
    ...
    const step3Path = path.join(OUTPUT_DIR, 'step-3-city.png')
