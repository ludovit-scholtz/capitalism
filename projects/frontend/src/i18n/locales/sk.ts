export default {
  ...
  onboarding: {
    ...
    step1Desc: 'Vyberte podnikateľskú fantasy, s ktorou chcete začať. Jedno kliknutie vás presunie priamo na štartovacie produkty tohto odvetvia.',
    step2Title: 'Vyberte prvý produkt',
    step2Desc: 'Vyberte si jeden z troch štartovacích produktov. Karty ukazujú lokálnu cenu pre každé štartovacie mesto.',
    step3Title: 'Vyberte mesto',
    step3Desc: 'Vyberte mesto, v ktorom bude pôsobiť vaša prvá firma. Jedno kliknutie vás posunie na výber IPO plánu.',
