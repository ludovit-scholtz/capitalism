export default {
  ...
  operations: {
    eyebrow: 'Operations',
    title: 'Operations Dashboard',
    subtitle: 'Comprehensive visibility into game operations, player management, and financial analytics.',
    nav: {
    ...
    statistics: {
      ...
      subtitle: 'Money flow over the last {window} ticks.',
      ...
      noData: 'No financial activity in the last {window} ticks.',
    },
    news: {
      title: 'News & Changelog Manager',
      subtitle: 'View, edit, and publish news entries and changelogs across the game network.',
    ...
    players: {
      ...
      subtitle: 'Search, sort, and take intervention actions on player accounts.',
