export default {
  ...
  onboarding: {
    ...
    configureStepPriceDescWithPrice: 'In the sales shop, open the PUBLIC_SALES unit and set a minimum selling price for your product. Start near the base market price of {price}.',
