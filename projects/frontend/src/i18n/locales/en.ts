export default {
  ...
  auth: {
    ...
    forgotPasswordDescription:
      'Enter your account email and we will send you a one-time reset link if the account exists.',
    ...
    oidcOnlyBanner:
      'This server uses single sign-on. If you cannot access your account, re-authenticate with your identity provider or contact support.',
