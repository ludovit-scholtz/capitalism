      ...
      <div class="container">
        ...
        <div class="exchange-hero-meta">
          <span class="exchange-tick-chip" :title="currentTick !== null ? t('globalExchange.tickHint', { tick: currentTick }) : undefined">
            ...
            <span class="exchange-tick-value">{{ formattedSnapshotTime || 'ÔÇö' }}</span>
          </span>
                ...
                <div class="offer-metrics">
                  ...
                  <div class="offer-metric">
                    ...
                    <span class="metric-value transit-cost">
                      +{{ formatPrice(offer.transitCostPerUnit) }} ┬Ě {{ offer.distanceKm }} km
                      <span
                      ...
                      >ÔŤŻ ├Ś{{ offer.fuelPriceIndex.toFixed(2) }}</span>
                    </span>
                  </div>
                  ...
                  <div class="offer-metric">
                    ...
                    <span class="metric-value quality-value">
                      <span class="quality-range"> {{ formatPercent(offer.qualityMin) }}&nbsp;ÔÇô&nbsp;{{ formatPercent(offer.qualityMax) }} </span>
