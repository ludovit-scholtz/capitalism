...
const props = defineProps<{
  ...
  selectedResolvedGameYear: number | null
}>()

const emit = defineEmits<{
  (e: 'drill-toggle', category: string | null): void
  (e: 'select-game-year', year: number | null): void
}>()
...
function getEffectiveCurrencyCode(currencyCode?: string | null): string {
  return currencyCode ?? props.ledger.primaryCurrencyCode ?? 'EUR'
}

function showInlineCurrencyBadge(entryCurrencyCode?: string | null): boolean {
  return (entryCurrencyCode ?? 'EUR') !== (props.ledger.primaryCurrencyCode ?? 'EUR')
}
  ...
  <div class="ledger-content">
      ...
      <div class="statement-card meta-card">
        ...
        <div class="history-buttons">
          <button
            ...
            @click="emit('select-game-year', yearItem.isCurrentGameYear ? null : yearItem.gameYear)"
          >
      ...
      <div class="statement-card">
        ...
        <div class="statement-rows">
          <div class="statement-row">
            ...
            <button class="drill-btn" :class="{ active: drillCategory === 'REVENUE' }" :aria-label="$t('ledger.drillDown') + ': ' + $t('ledger.revenue')" @click="emit('drill-toggle', 'REVENUE')">
          ...
          <div v-if="(ledger.totalMediaHouseIncome ?? 0) > 0" class="statement-row media-house-income-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'MEDIA_HOUSE_INCOME')"
            >
          ...
          <div v-if="(ledger.totalDepositInterestReceived ?? 0) > 0" class="statement-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'DEPOSIT_INTEREST_RECEIVED')"
            >
          ...
          <div v-if="(ledger.totalLoanInterestIncome ?? 0) > 0" class="statement-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'LOAN_INTEREST_INCOME')"
            >
          ...
          <div class="statement-row cost-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'PURCHASING_COST')"
            >
          ...
          <div v-if="ledger.totalShippingCosts > 0" class="statement-row cost-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'SHIPPING_COST')"
            >
          ...
          <div v-if="ledger.totalLaborCosts > 0" class="statement-row cost-row">
            ...
            <button class="drill-btn" :class="{ active: drillCategory === 'LABOR_COST' }" :aria-label="$t('ledger.drillDown') + ': ' + $t('ledger.laborCosts')" @click="emit('drill-toggle', 'LABOR_COST')">
          ...
          <div v-if="ledger.totalEnergyCosts > 0" class="statement-row cost-row">
            ...
            <button class="drill-btn" :class="{ active: drillCategory === 'ENERGY_COST' }" :aria-label="$t('ledger.drillDown') + ': ' + $t('ledger.energyCosts')" @click="emit('drill-toggle', 'ENERGY_COST')">
          ...
          <div v-if="(ledger.totalDepositInterestPaid ?? 0) > 0" class="statement-row cost-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'DEPOSIT_INTEREST_PAID')"
            >
          ...
          <div v-if="(ledger.totalLoanInterestExpense ?? 0) > 0" class="statement-row cost-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'LOAN_INTEREST_EXPENSE')"
            >
          ...
          <div v-if="ledger.totalTaxPaid > 0" class="statement-row cost-row">
            ...
            <button class="drill-btn" :class="{ active: drillCategory === 'TAX' }" :aria-label="$t('ledger.drillDown') + ': ' + $t('ledger.taxPaid')" @click="emit('drill-toggle', 'TAX')">
              {{ drillCategory === 'TAX' ? '▲' : '▼' }}
            </button>
          </div>
        ...
        <div class="statement-rows">
          ...
          <div class="statement-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'PROPERTY_PURCHASE')"
            >
          ...
          <div class="statement-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'BUILDING_VALUE')"
            >
          ...
          <div class="statement-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'INVENTORY_VALUE')"
            >
          ...
          <div v-if="(ledger.totalDepositsPlaced ?? 0) > 0" class="statement-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'DEPOSIT_MADE')"
            >
        ...
        <div class="statement-rows">
          ...
          <div v-if="ledger.totalStockPurchaseCashOut > 0" class="statement-row">
            ...
            <button
              ...
              @click="emit('drill-toggle', 'STOCK_PURCHASE')"
            >
          ...
          <div v-if="ledger.totalStockSaleCashIn > 0" class="statement-row">
            ...
            <button class="drill-btn" :class="{ active: drillCategory === 'STOCK_SALE' }" :aria-label="$t('ledger.drillDown') + ': ' + $t('ledger.stockSales')" @click="emit('drill-toggle', 'STOCK_SALE')">
    ...
    <div v-if="drillCategory" class="drill-panel">
      <div class="drill-header">
        ...
        <button class="btn btn-ghost btn-sm" @click="emit('drill-toggle', null)">
          ✕ {{ $t('common.close') }}
        </button>
      </div>
