...
const { locale, building, loading, isEditing, buildingFinancialTimeline, buildingFinancialTimelineLoading, layoutName, layoutDescription, masterLayouts, masterLayoutsLoading, masterLayoutsError, localLayouts, layoutSaving, layoutSaveError, layoutSaveSuccess, layoutDeleteError, overwriteConfirmPending, draftConstructionCost, projectedCompanyCashAfterApply, buildingOverviewCityName, cityCurrencyCode, buildingOverviewMapRoute, buildingFinancialSnapshots, buildingFinancialHasActivity, masterConnected, masterUserEmail, saveLayout, requestLoadLayout, confirmOverwrite, cancelOverwrite, deleteLayout, layoutStructureSummary, formatCurrency, formatBuildingType, formatGameTickTime, getUnitColor, getLayoutCellType, formatGpsLocation, loadBuilding } = bd
</script>
