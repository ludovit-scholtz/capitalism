...
const { locale, building, isEditing, selectedCell, showUnitPicker, resourceTypes, rankedProducts, rankedProductsLoading, cities, exchangeOffersLoading, exchangeSortBy, cityMediaHouses, cityMediaHousesLoading, selectedHistoryItemKey, schedulingUpgrade, unitUpgradeError, plannedUnits, allowedUnits, selectedPurchaseUnit, selectedDraftPurchaseUnit, publicSalesFilteredRankedProducts, b2bSalesFilteredRankedProducts, selectedHistoryItemOptions, selectedUnitResourceHistory, cityCurrencyCode, b2bPriceSource, b2bSuggestedPrice, b2bHasUpstreamSource, exchangeOfferItems, allExchangeOffersBlocked, bestExchangeOfferCityId, logisticsTrapWarning, selectedPurchaseResourceSlug, selectedPurchaseSelection, selectedPurchaseVendorSummary, selectedDraftMediaHouse, selectedCellPendingUpgrade, selectedCellUpgradeInfo, isSelectedCellStaged, selectedPlannedUnitFlowSegments, setReadOnlySelectedCell, placeUnit, removeDraftUnit, getDraftUnitAt, getDisplayedTicks, getItemSelection, setItemSelection, openPurchaseSelector, getManufacturingSelectableItems, getResourceName, getProductName, getBrandScopeLabel, getUnitInventorySummary, getUnitInventories, getUnitInventoryItemCount, toggleStagedUpgrade, updateSelectedUnitConfig, formatCurrency, formatTickDuration, formatPercent, formatUnitQuantity, getUnitColor, getUnitAtFrom, getInventoryItemImageUrl, getInventoryItemMonogram, getInventoryItemSourcingCostPerUnitLabel, getInventoryItemName, getInventoryItemSourcingCostLabel, getDraftUnitConstructionCostLabel, getUnitInventoryCostLabel, getUnitConstructionCost, getLocalizedIndustry, submitUnitUpgrade , SUPPORTED_INDUSTRIES } = bd
</script>
