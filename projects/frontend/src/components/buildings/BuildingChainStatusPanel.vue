...
<template>
  ...
  >
    <div class="chain-panel-header mb-4 flex flex-wrap items-center gap-2">
      ...
      >
        {{ t('buildingDetail.salesChain.dismiss') }}
      </button>
    </div>
    ...
    <div class="chain-flow flex flex-wrap items-center gap-2 sm:gap-3" role="list" :aria-label="t('buildingDetail.accessibility.salesChainSteps')">
      ...
      <div
        class="chain-step min-w-[180px] flex-1 rounded-lg border p-3"
        :class="shopChainStatus.isPurchaseConfigured ? 'chain-step--configured border-emerald-300/60 bg-emerald-500/10' : 'chain-step--missing border-amber-300/60 bg-amber-500/10'"
        role="listitem"
      >
        <div class="chain-step-icon text-lg">🛒</div>
        <div class="chain-step-type mt-1 text-xs font-semibold uppercase tracking-wide text-muted">{{ t('buildingDetail.unitTypes.PURCHASE') }}</div>
      ...
      <div
        class="chain-step min-w-[180px] flex-1 rounded-lg border p-3"
        :class="shopChainStatus.isPublicSalesConfigured ? 'chain-step--configured border-emerald-300/60 bg-emerald-500/10' : 'chain-step--missing border-amber-300/60 bg-amber-500/10'"
        role="listitem"
      >
        <div class="chain-step-icon text-lg">💲</div>
