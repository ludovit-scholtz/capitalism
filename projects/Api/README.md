...
`Api` is the GraphQL backend for the event catalog application. It replaces the starter schema with a production-oriented domain model for curated event discovery, community submissions, contributor dashboards, and admin moderation.
