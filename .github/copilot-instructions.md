...
- **ManufacturingEncyclopediaView** (`/encyclopedia`): Encyclopedia cards render in a compact 6-column wide-screen grid; the page includes in-app gameplay help plus visual onboarding and manufacturing-setup guide sections that must stay synchronized with onboarding flow changes.
