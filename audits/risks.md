...
- **Demolition or sale valuation drift from construction pricing**: Mitigated. Building market valuation now derives from the same rebuild inputs players would pay today: current lot price, current building construction cost, and active-unit replacement cost including upgrade steps. Residual requirement: whenever land, shell, or unit pricing changes, update the shared valuation calculator and keep destroy/sale regression tests aligned so refund arbitrage does not reappear.
